...
# OpenAI API
OPENAI_API_KEY = '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'    # Paste your API Key here
...
def weather(location, country):
  ...
  apiKey = 'bbe4071962747e10331cc9721d24dd25' # Enter your API Key here for weather
